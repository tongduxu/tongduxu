...
public class DateFormatter {
	...
	public CharSequence getDayName(LunarCalendar lc) {
		...
		if (day < 11) {
			result.append(getArrayString(R.array.chinesePrefix, 0));     //R.array.chinesePrefix在string.xml里
	...
	//我自己加的
	public String getsolarDate(LunarCalendar lc) {
		return (lc.getGregorianDate(Calendar.MONTH)+1)+"."+lc.getGregorianDate(Calendar.DAY_OF_MONTH);
	}
